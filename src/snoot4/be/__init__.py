...
class Backend(Component):
    ...
    def elaborate(self, platform):
        ...
        x_op1 = Signal(32)
        x_op2 = Signal(32)
        m.d.comb += x_op1.eq(dx_ra_val)
        with m.Switch(dx_op2_sel):
            with m.Case(Op2Sel.RB):
                m.d.comb += x_op2.eq(dx_rb_val)
            with m.Case(Op2Sel.R0):
                m.d.comb += x_op2.eq(dx_r0_val)
...
if __name__ == "__main__":
    ...
    def proc():
        ...
        # ADD #1,R4     R4 + 1   -> R4    0111 0100 0000 0001
        yield uut.instruction.eq(0b0111_0100_0000_0001)
        yield
